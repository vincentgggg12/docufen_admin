...
// import { DocumentTemplate, DocumentType } from "./NonConformanceModal";
// import { convertDocxFileToDfn } from "@/lib/documentUtils";

// interface DeviationFormModalProps {
//   open: boolean;
//   onOpenChange: (open: boolean) => void;
//   deviationTemplateForm: DocumentTemplate;
//   setDeviationTemplateForm: React.Dispatch<React.SetStateAction<DocumentTemplate>>;
//   editingTemplateId: string | null;
//   onSave: (template: DocumentTemplate, docString: string) => void;
//   t: (key: string) => string;
// }

// export function DeviationFormModal({
//   open,
//   onOpenChange,
//   deviationTemplateForm = {
//     documentName: "",
//     documentNumber: "",
//     versionNo: "",
//     documentType: "deviation" as DocumentType
//   },
//   setDeviationTemplateForm,
//   editingTemplateId,
//   onSave,
//   t,
...
//   const callOnSave = () => {
//     console.log("DeviationFormModal - callOnSave called");
...
//         ...deviationTemplateForm,
//         documentName: deviationTemplateForm?.documentName || documentFile?.name || "",
//         documentFileName: documentFile?.name || "",
//         documentNumber: deviationTemplateForm?.documentNumber || "",
//         versionNo: deviationTemplateForm?.versionNo || "",
//         documentType: "deviation" as DocumentType
//       };
...
//       });
//     }
//   }, [deviationTemplateForm, setDeviationTemplateForm]);
...
//       setIsUploading(false);
//     }
//   }, [deviationTemplateForm, setDeviationTemplateForm, setDocString]);
...
//         <DialogHeader>
//           <DialogTitle>
//             {editingTemplateId ? "Edit Deviation Template" :
//               currentStep === 1 ? "Add Deviation Template" : "Approve Deviation Template"}
//           </DialogTitle>
//           <DialogDescription>
//             {editingTemplateId
//               ? "Edit your deviation form template"
//               : currentStep === 1
//                 ? "Upload or set a template for deviation forms. Users will use this template to log deviations from their documents."
...
//                 value={deviationTemplateForm?.documentName || ""}
//                 onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
//                   setDeviationTemplateForm({ ...deviationTemplateForm, documentName: e.target.value })
//                 }
//               />
//             </div>
//             <div className="space-y-2">
...
//                 id="documentNumber"
//                 className="text-foreground"
//                 value={deviationTemplateForm?.documentNumber || ""}
//                 onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
//                   setDeviationTemplateForm({ ...deviationTemplateForm, documentNumber: e.target.value })
//                 }
//               />
//             </div>
//             <div className="space-y-2">
...
//                 id="versionNo"
//                 className="text-foreground"
//                 value={deviationTemplateForm?.versionNo || ""}
//                 onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
//                   setDeviationTemplateForm({ ...deviationTemplateForm, versionNo: e.target.value })
//                 }
//               />
//             </div>
//             <div className="mb-4">
...
//                         setDeviationTemplateForm({ ...deviationTemplateForm, documentFileName: "" });
//                       }}
//                       className="mt-4"
//                     >
...
//                 <div>
//                   <h3 className="font-semibold text-lg">{deviationTemplateForm?.documentName || documentFile?.name}</h3>
//                   <p className="text-sm text-muted-foreground">{documentFile?.name}</p>
//                   {deviationTemplateForm?.documentNumber && (
//                     <p className="text-sm">Document Number: {deviationTemplateForm?.documentNumber}</p>
//                   )}
//                   {deviationTemplateForm?.versionNo && (
//                     <p className="text-sm">Version: {deviationTemplateForm?.versionNo}</p>
//                   )}
//                 </div>
//               </div>
...
//                     I hereby confirm that this is the current Deviation template approved for official use in our organisation.
//                   </Label>
//                 </div>
